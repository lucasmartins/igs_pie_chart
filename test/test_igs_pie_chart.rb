...
class IgsPieChartTest < Test::Unit::TestCase
  ...
  def test_pie_chart_rendering
    ...
    pie = PieChart.new(200,0.4,'body',{'one'=>1.1,'two'=>2.2,'tree'=>3.3,'five'=>5.5,'eight'=>8.8,'thirteen'=>13.13,'twenty_one'=>21.21,'thirty_four'=>34.34,'fifty_five'=>55.55,'eighty_nine'=>89.89,'a_hundread_forty_four'=>144.144})
    @render = pie.render
